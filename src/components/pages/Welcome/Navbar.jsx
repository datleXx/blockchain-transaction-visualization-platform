...
//teamplate to use for sidebar, simply is a link tag with specific styling for the sidebar items 
            ...
            <nav className="flex justify-between h-13 text-[#4b64d1]">
                <div className="md:fixed w-[95%] text-sm sm:text-xs font-bold text-black">  
                    <div className="flex">
                        ...
                        <div className="hidden md:flex items-center md:w-[45%] ml-[5%]">
                            ...
                            <Link to ="/mainpage" className = "p-3 hover:bg-[rgb(75,100,209)]  rounded-xl hover:rounded-xl hover:scale-105 duration-300 transform hover:text-white ">Get Started</Link>
                            <Link to ="/transactionpage" className = "p-3 hover:bg-[rgb(75,100,209)]  rounded-xl hover:rounded-xl hover:scale-105 duration-300 transform hover:text-white ">Transaction Table</Link> 
                        </div>
                        {/* the navbar icon if user want to access navbar from the side */}
                        <div onClick={handleNav} className="fixed top-[2%] right-[3px] md:">
                ...
                <div className={!nav ? "fixed left-0 top-0 sm:w-[30%] md:w-[20%] h-full text-[#4b64d1] border-r border-r-[#4b64d1] bg-white ease-in-out duration-500": "fixed right-[100%]"}>
                    ...
                    <ul className="uppercase p-2 text-sm flex flex-col">
                        ...
                        <NavMobile onClick={handleNav} to="/transactionpage" value="Transaction Page"/>
                    </ul>
                </div>
            </nav>
    )
